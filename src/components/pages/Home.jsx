...
function Home(){
   ...
   function SampleNextArrow(props) {
      ...
      return (
        <div
          className={className}
          style={{ ...style, display: "flex", background: "black", height: '100%', alignItems: 'center' }}
          onClick={onClick}
        />
      );
   }
   ...
   useEffect(()=>{
      getMovie("https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=pt-br&page=2&sort_by=popularity.desc")
   },[])
               ...
               {moviesRecomendados.length ? (
                  ...
                  <> 
                     ...
                     <Slider {...settings}>
                        ...
                        {movies.map((moviesRecomendation) => 
                           <> 
